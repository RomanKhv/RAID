...
const Hall _MyHall({
	{ Element::Blue,  { {StatType::HP_p,2}, {StatType::Atk_p,2}, {StatType::Def_p,2}, {StatType::CDmg,2}, {StatType::Res,5}, {StatType::Acc,60} }, },
...
const std::vector<Artefact> _MyArts =
{
	...
	Artefact{ ArtType::Helmet, ArtSet::HP, 6, 16, StatType::HP, { {StatType::Spd,29,1}, {StatType::HP_p,7,1}, {StatType::Res,11,2}, {StatType::Atk_p,6,1} }, ChampionName::none/*Lekar*/, "Lekar" },
	Artefact{ ArtType::Shield, ArtSet::HP, 6, 16, StatType::Def, { {StatType::CRate,7}, {StatType::Acc,22}, {StatType::Def_p,16,1}, {StatType::Res,20,2} }, ChampionName::none/*Lekar*/, "Lekar" },
	...
	Artefact{ ArtType::Chest, ArtSet::HP, 5, 16, StatType::Def_p, { {StatType::HP_p,5,1}, {StatType::Spd,5,1}, {StatType::Atk_p,6,1}, {StatType::Atk,19,5} }, ChampionName::none/*Lekar*/, "Lekar" },
	Artefact{ ArtType::Boots, ArtSet::HP, 6, 16, StatType::Def_p, { {StatType::CRate,12}, {StatType::CDmg,12}, {StatType::HP,445,100}, {StatType::Atk,23,5} }, ChampionName::none/*Lekar*/, "Lekar" },
	...
	// Def
	Artefact{ ArtType::Weapon, ArtSet::Def, 5, 8, StatType::Atk, { {StatType::Spd,9}, {StatType::HP_p,4}, {StatType::Atk_p,10} } },
	...
	Artefact{ ArtType::Weapon, ArtSet::Acc, 4, 12, StatType::Atk, { {StatType::Spd,11,1}, {StatType::HP_p,4,1}, {StatType::Acc,6,2} } },
	...
	Artefact( ArtType::Weapon, ArtSet::Speed, 6, 12, StatType::Atk, { {StatType::HP_p,7}, {StatType::CDmg,17}, {StatType::CRate,11}, {StatType::HP,527} } ),
	  Artefact( ArtType::Weapon, ArtSet::Speed, 6, 16, StatType::Atk, { {StatType::HP_p,6,1}, {StatType::Spd,12,2}, {StatType::HP,816}, {StatType::Acc,31} }, ChampionName::Gorgorab ),
	...
	Artefact{ ArtType::Weapon, ArtSet::Speed, 5, 16, StatType::Atk, { {StatType::Acc,32}, {StatType::HP_p,5,1}, {StatType::CDmg,11}, {StatType::Atk_p,5} } },
	  Artefact{ ArtType::Weapon, ArtSet::Speed, 5, 16, StatType::Atk, { {StatType::CRate,11}, {StatType::HP_p,8,1}, {StatType::Spd,5,1}, {StatType::Res,8} }, ChampionName::none/*Lekar*/, "Lekar" },
	...
	Artefact{ ArtType::Helmet, ArtSet::Speed, 6, 16, StatType::HP, { {StatType::CDmg,11}, {StatType::Def_p,11}, {StatType::HP_p,14}, {StatType::Spd,6} } },
	...
	Artefact{ ArtType::Helmet, ArtSet::Speed, 5, 8, StatType::HP, { {StatType::HP_p,11}, {StatType::Acc,9} } },
	  Artefact( ArtType::Helmet, ArtSet::Speed, 4, 12, StatType::HP, { {StatType::Def_p,4,1}, {StatType::Spd,9,1}, {StatType::Acc,9} }, ChampionName::Gorgorab ),
	...
	Artefact{ ArtType::Shield, ArtSet::Speed, 5, 12, StatType::Def, { {StatType::CRate,10}, {StatType::HP_p,10}, {StatType::HP,286} } },
	...
	Artefact{ ArtType::Shield, ArtSet::Speed, 5, 12, StatType::Def, { {StatType::HP_p,12}, {StatType::Acc,9}, {StatType::Spd,4,1}, {StatType::CDmg,6} } },
	  Artefact( ArtType::Shield, ArtSet::Speed, 5, 16, StatType::Def, { {StatType::HP,197}, {StatType::CDmg,15}, {StatType::Spd,9+3}, {StatType::Acc,10} }, ChampionName::Gorgorab ),
	...
	Artefact{ ArtType::Gloves, ArtSet::Speed, 5, 16, StatType::CRate, { {StatType::Acc,29,2}, {StatType::Def_p,10,1}, {StatType::Atk,21,5}, {StatType::Res,11,2} } },
	  ...
	  Artefact{ ArtType::Gloves, ArtSet::Speed, 5, 12, StatType::CRate, { {StatType::Atk,21,5}, {StatType::Def,34,5}, {StatType::Spd,14,1} }, ChampionName::none/*Lekar*/, "Lekar" },
	Artefact{ ArtType::Gloves, ArtSet::Speed, 5, 8, StatType::Def_p, { {StatType::HP,403}, {StatType::HP_p,6}, {StatType::Acc,25} } },
	Artefact{ ArtType::Gloves, ArtSet::Speed, 5, 12, StatType::Def_p, { {StatType::Acc,21}, {StatType::CRate,10}, {StatType::HP,290} } },
	...
	Artefact{ ArtType::Chest, ArtSet::Speed, 4, 10, StatType::Def_p, { {StatType::Atk,23}, {StatType::HP_p,9} } },
	  Artefact( ArtType::Chest, ArtSet::Speed, 4, 12, StatType::Def_p, { {StatType::HP_p,5,1}, {StatType::Spd,10,1}, {StatType::HP,277} }, ChampionName::Gorgorab ),
	...
	Artefact{ ArtType::Boots, ArtSet::Speed, 5, 16, StatType::Spd, { {StatType::Res,17,2}, {StatType::Acc,8,1}, {StatType::HP,234,100}, {StatType::Atk,23} } },
	  Artefact( ArtType::Boots, ArtSet::Speed, 5, 16, StatType::Spd, { {StatType::Def_p,9,1}, {StatType::Acc,19,2}, {StatType::Res,19,2}, {StatType::Atk,16,5} }, ChampionName::Gorgorab ),
	...
	Artefact{ ArtType::Helmet, ArtSet::Vamp, 5, 16, StatType::HP, { {StatType::HP_p,10}, {StatType::Acc,19}, {StatType::Spd,4}, {StatType::Def_p,4,1} } },
	Artefact{ ArtType::Helmet, ArtSet::Vamp, 5, 12, StatType::HP, { {StatType::CRate,6}, {StatType::HP_p,14}, {StatType::Atk,21} } },
	Artefact{ ArtType::Helmet, ArtSet::Vamp, 5, 12, StatType::HP, { {StatType::Spd,15}, {StatType::Def_p,4}, {StatType::Atk,15,5} } },
	...
	Artefact{ ArtType::Gloves, ArtSet::Vamp, 5, 12, StatType::Def_p, { {StatType::CDmg,10}, {StatType::Def,35}, {StatType::Acc,35} } },
	...
	Artefact( ArtType::Shield, ArtSet::Cruel, 5, 12, StatType::Def, { {StatType::CDmg,15}, {StatType::Spd,5} } ),
	Artefact( ArtType::Shield, ArtSet::Cruel, 5, 8, StatType::Def, { {StatType::Spd,9}, {StatType::HP_p,8}, {StatType::Res,9} } ),
	...
	Artefact( ArtType::Gloves, ArtSet::Cruel, 5, 8, StatType::CRate, { {StatType::Res,9}, {StatType::Def_p,14} } ),
	...
	Artefact( ArtType::Weapon, ArtSet::Immortal, 5, 16, StatType::Atk, { {StatType::HP_p,14}, {StatType::Spd,8}, {StatType::CDmg,4}, {StatType::HP,709} } ),
	...
	Artefact( ArtType::Shield, ArtSet::Immortal, 5, 12, StatType::Def, { {StatType::CRate,8}, {StatType::HP_p,14}, {StatType::Spd,5} } ),
	...
	Artefact( ArtType::Chest, ArtSet::Immortal, 5, 12, StatType::Def_p, { {StatType::Atk,14}, {StatType::Res,19}, {StatType::CRate,10}, {StatType::HP_p,11} } ),
	...
	Artefact( ArtType::Chest, ArtSet::Immortal, 5, 12, StatType::Def_p, { {StatType::CRate,9}, {StatType::Spd,9}, {StatType::Acc,9} } ),
	...
	Artefact( ArtType::Shield, ArtSet::DivAtk, 5, 12, StatType::Def, { {StatType::HP_p,10}, {StatType::CRate,8}, {StatType::HP,425} } ),
	...
	// DivCritRate
	Artefact( ArtType::Weapon, ArtSet::DivCritRate, 5, 8, StatType::Atk, { {StatType::HP_p,11}, {StatType::Atk_p,10}, {StatType::Acc,8} } ),
	...
	Artefact( ArtType::Shield, ArtSet::DivCritRate, 5, 12, StatType::Def, { {StatType::CRate,10}, {StatType::CDmg,10}, {StatType::Acc,18}, {StatType::Spd,8} } ),
	...
	Artefact( ArtType::Helmet, ArtSet::DivSpeed, 5, 12, StatType::HP, { {StatType::Def,37}, {StatType::Def_p,10}, {StatType::HP_p,9} } ),

	Artefact( ArtType::Shield, ArtSet::DivSpeed, 6, 12, StatType::Def, { {StatType::Acc,10}, {StatType::HP,651}, {StatType::Spd,11}, {StatType::CDmg,11} } ),
	...
	Artefact( ArtType::Necklace, ArtSet::HolyOrden, 4, 8, StatType::CDmg, { {StatType::HP,143}, {StatType::Acc,16} }, ChampionName::Gromoboy ),
	Artefact( ArtType::Banner, ArtSet::HolyOrden, 5, 12, StatType::Acc, { {StatType::HP_p,12,1}, {StatType::HP,232}, {StatType::Def_p,4,1} }, ChampionName::Gromoboy ),
	...
	Artefact{ ArtType::Necklace, ArtSet::DarkElves, 5, 0, StatType::Atk, { {StatType::Acc,9}, }, ChampionName::VisirOvelis },
