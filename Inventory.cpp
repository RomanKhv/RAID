...
const Hall _MyHall({
	{ Element::Blue,  { {StatType::HP_p,6}, {StatType::Atk_p,4}, {StatType::Def_p,8}, {StatType::CDmg,12}, {StatType::Res,15}, {StatType::Acc,80} }, },
	{ Element::Green, { {StatType::HP_p,8}, {StatType::Atk_p,6}, {StatType::Def_p,6}, {StatType::CDmg,12}, {StatType::Res,15}, {StatType::Acc,50} }, },
	{ Element::Red,   { {StatType::HP_p,4}, {StatType::Atk_p,3}, {StatType::Def_p,4}, {StatType::CDmg,8},  {StatType::Res,5}, {StatType::Acc,50} }, },
	{ Element::Void,  { {StatType::HP_p,6}, {StatType::Atk_p,3}, {StatType::Def_p,6}, {StatType::CDmg,10}, {StatType::Res,20}, {StatType::Acc,50} }, },
});
...
#pragma region 
	...
	Artefact{ ArtType::Boots, ArtSet::Atk, 5, 16, StatType::Spd, { {StatType::CRate,9}, {StatType::Def_p,6,2}, {StatType::CDmg,5}, {StatType::Acc,11} }, ChampionName::Revoglas },
#pragma endregion 
...
#pragma region Acc
	...
	Artefact{ ArtType::Chest, ArtSet::Acc, 5, 12, StatType::HP_p, { {StatType::CRate,5}, {StatType::Def_p,10}, {StatType::Acc,31} } },
	  Artefact{ ArtType::Chest, ArtSet::Acc, 5, 12, StatType::Atk_p, { {StatType::HP_p,10,3}, {StatType::Def_p,10,2}, {StatType::Spd,4,2} }, ChampionName::Reya },
...
#pragma region 
	...
	Artefact{ ArtType::Weapon, ArtSet::Vamp, 5, 12, StatType::Atk, { {StatType::Spd,9}, {StatType::HP_p,10}, {StatType::Acc,18} } },
	...
	Artefact{ ArtType::Shield, ArtSet::Vamp, 5, 8, StatType::Def, { {StatType::Def_p,5}, {StatType::Acc,30} } },
	...
	Artefact{ ArtType::Gloves, ArtSet::Vamp, 5, 12, StatType::Def_p, { {StatType::HP,340}, {StatType::Spd,8}, {StatType::Acc,28} } },
	...
	Artefact( ArtType::Chest, ArtSet::Vamp, 5, 13, StatType::HP_p, { {StatType::Acc,30}, {StatType::Spd,5}, {StatType::CDmg,6} } ),
	...
	Artefact( ArtType::Chest, ArtSet::Vamp, 5, 12, StatType::HP_p, { {StatType::Spd,14,1}, {StatType::Acc,11,1}, {StatType::HP,360} } ),
	...
	Artefact( ArtType::Chest, ArtSet::Vamp, 5, 12, StatType::Def_p, { {StatType::Acc,11}, {StatType::CDmg,15}, {StatType::Def,20} } ),
	...
	Artefact{ ArtType::Boots, ArtSet::Vamp, 6, 8, StatType::Atk_p, { {StatType::CRate,7}, {StatType::Def_p,12}, {StatType::Atk,26}, {StatType::HP_p,11} } },
	  ...
	  Artefact( ArtType::Boots, ArtSet::Vamp, 5, 15, StatType::Spd, { {StatType::CDmg,9}, {StatType::Acc,8}, {StatType::Def_p,8,1}, {StatType::HP,500,100} }, ChampionName::Vergis ),
...
#pragma region 
	...
	Artefact{ ArtType::Helmet, ArtSet::Shield, 6, 12, StatType::HP, { {StatType::Acc,10}, {StatType::Spd,16}, {StatType::HP_p,6} } },
	...
	Artefact{ ArtType::Helmet, ArtSet::Shield, 5, 12, StatType::HP, { {StatType::CRate,11}, {StatType::CDmg,9}, {StatType::Def_p,5} } },
	...
	Artefact{ ArtType::Chest, ArtSet::Shield, 5, 12, StatType::HP_p, { {StatType::Atk,40}, {StatType::Acc,21}, {StatType::CDmg,12} } },
...
#pragma endregion 
	...
	// Оглушение
	  Artefact( ArtType::Weapon, ArtSet::Stun, 5, 12, StatType::Atk, { {StatType::Acc,27,3}, {StatType::Atk_p,10,4}, {StatType::Spd,5,2} }, ChampionName::Reya ),
	...
	Artefact( ArtType::Weapon, ArtSet::Stun, 5, 12, StatType::Atk, { {StatType::Spd,10}, {StatType::Atk_p,11}, {StatType::Res,8} } ),
	  ...
	  Artefact( ArtType::Helmet, ArtSet::Stun, 5, 12, StatType::HP, { {StatType::Res,17,5}, {StatType::CDmg,10}, {StatType::Spd,10,1}, {StatType::Def_p,6,4} }, ChampionName::Reya ),
	...
	Artefact( ArtType::Helmet, ArtSet::Stun, 5, 12, StatType::HP, { {StatType::Def_p,11}, {StatType::CRate,10}, {StatType::Atk_p,6} } ),
	  ...
	  Artefact( ArtType::Shield, ArtSet::Stun, 5, 12, StatType::Def, { {StatType::Spd,17,2}, {StatType::Acc,12,3}, {StatType::CRate,12}, {StatType::Res,10,3} }, ChampionName::Reya ),

	Artefact( ArtType::Gloves, ArtSet::Stun, 6, 12, StatType::CDmg, { {StatType::HP_p,12}, {StatType::Spd,10}, {StatType::Atk,43} } ),
	  Artefact( ArtType::Gloves, ArtSet::Stun, 6, 12, StatType::CRate, { {StatType::CDmg,18}, {StatType::Atk_p,7,2}, {StatType::HP,395} }, ChampionName::Reya ),
...
#pragma region 
	...
	Artefact( ArtType::Helmet, ArtSet::Immortal, 5, 12, StatType::HP, { {StatType::Acc,20}, {StatType::Spd,10}, {StatType::CDmg,4}, {StatType::HP_p,11} } ),
	...
	Artefact( ArtType::Helmet, ArtSet::Immortal, 5, 12, StatType::HP, { {StatType::CRate,9}, {StatType::Spd,9}, {StatType::Res,11} } ),
	  ...
	  Artefact( ArtType::Shield, ArtSet::Immortal, 5, 16, StatType::Def, { {StatType::Def_p,6,1}, {StatType::Acc,28,2}, {StatType::HP_p,4,1}, {StatType::Spd,15,1} }, ChampionName::SerjantA ),
...
#pragma endregion 
	...
	Artefact( ArtType::Weapon, ArtSet::Zhivuchest, 6, 12, StatType::Atk, { {StatType::CDmg,26}, {StatType::Acc,10}, {StatType::Spd,5} } ),
	...
	Artefact( ArtType::Shield, ArtSet::Zhivuchest, 5, 12, StatType::Def, { {StatType::Acc,8}, {StatType::Def_p,13}, {StatType::Spd,9} } ),
	...
	Artefact( ArtType::Gloves, ArtSet::Zhivuchest, 5, 12, StatType::HP_p, { {StatType::Def_p,5}, {StatType::Acc,28}, {StatType::Def,36}, {StatType::Atk_p,6} } ),
	...
	Artefact( ArtType::Chest, ArtSet::Zhivuchest, 6, 12, StatType::Def_p, { {StatType::Spd,11}, {StatType::CDmg,11}, {StatType::Res,11}, {StatType::CRate,11} } ),
	...
	Artefact( ArtType::Boots, ArtSet::Zhivuchest, 6, 12, StatType::Spd, { {StatType::Acc,9}, {StatType::Def,51}, {StatType::Def_p,19}, {StatType::Res,11} } ),
	...
	Artefact( ArtType::Boots, ArtSet::Zhivuchest, 6, 12, StatType::Spd, { {StatType::Acc,34}, {StatType::Def,17,5}, {StatType::HP_p,10} } ),
	...
	Artefact( ArtType::Helmet, ArtSet::Rastoropnost, 5, 12, StatType::HP, { {StatType::Def_p,16}, {StatType::Acc,18}, {StatType::CDmg,5} } ),
	...
	Artefact( ArtType::Gloves, ArtSet::Rastoropnost, 5, 12, StatType::Def_p, { {StatType::CDmg,11}, {StatType::Atk_p,11}, {StatType::Acc,18} } ),
	  Artefact( ArtType::Gloves, ArtSet::Rastoropnost, 5, 12, StatType::Def_p, { {StatType::Acc,19}, {StatType::CRate,10}, {StatType::Spd,5} }, ChampionName::Grash ),
	...
	Artefact( ArtType::Boots, ArtSet::Rastoropnost, 5, 12, StatType::Spd, { {StatType::Acc,29}, {StatType::CRate,5}, {StatType::Def,33} } ),
	Artefact( ArtType::Boots, ArtSet::Rastoropnost, 5, 12, StatType::Spd, { {StatType::CRate,9}, {StatType::Atk,37}, {StatType::Def_p,6} } ),
	  Artefact( ArtType::Boots, ArtSet::Rastoropnost, 5, 12, StatType::Spd, { {StatType::Atk_p,11}, {StatType::Acc,19}, {StatType::Def,16,5} }, ChampionName::Grash ),
	...
	Artefact( ArtType::Necklace, ArtSet::Bannerets, 5, 12, StatType::CDmg, { {StatType::Res,8,1}, {StatType::Acc,28,2}, {StatType::Atk,17,10} }, ChampionName::Sohaty ),
	...
	Artefact( ArtType::Banner, ArtSet::Barbarians, 5, 14, StatType::Acc, { {StatType::Def_p,15,1}, {StatType::Atk_p,4,1}, {StatType::HP_p,4,1} }, ChampionName::Fakhrakin ),
	...
	// Огрины
	Artefact( ArtType::Ring, ArtSet::Ogrins, 5, 9, StatType::Def, { {StatType::HP_p,5,1}, {StatType::Def_p,13,1} }, ChampionName::Grash ),
	Artefact( ArtType::Ring, ArtSet::Ogrins, 5, 12, StatType::Def, { {StatType::HP_p,10,1}, {StatType::Def_p,11,1}, {StatType::Atk_p,4,1} }, ChampionName::Kostolom ),
	...
	Artefact{ ArtType::Ring, ArtSet::DarkElves, 5, 9, StatType::HP, { {StatType::Atk_p,15,3}, {StatType::HP_p,6,4} }, ChampionName::Reya },
	...
	// Гномы
	Artefact( ArtType::Ring, ArtSet::Dworves, 6, 12, StatType::Def, { {StatType::Def_p,13,3}, {StatType::HP_p,6,1}, {StatType::Atk_p,16,1} }, ChampionName::Gala ),
	Artefact( ArtType::Ring, ArtSet::Dworves, 5, 12, StatType::Def, { {StatType::Def_p,10,3}, {StatType::HP,192,175}, {StatType::HP_p,16,1} }, ChampionName::SerjantA ),
	Artefact( ArtType::Necklace, ArtSet::Dworves, 5, 12, StatType::CDmg, { {StatType::Res,26}, {StatType::Acc,10}, {StatType::HP,323,1} }, ChampionName::Gala ),
	Artefact( ArtType::Banner, ArtSet::Dworves, 5, 12, StatType::Def, { {StatType::Atk_p,14}, {StatType::Spd,5}, {StatType::HP,333} }, ChampionName::Gala ),
};
