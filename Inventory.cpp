...
const std::vector<Artefact> _MyArts =
{
	...
	Artefact{ ArtType::Shield, ArtSet::Shield, 5, 8, StatType::Def, { {StatType::Spd,5}, {StatType::HP_p,11}, {StatType::Res,21} } },
	...
	Artefact( ArtType::Chest, ArtSet::Rastoropnost, 6, 12, StatType::HP_p, { {StatType::Acc,11}, {StatType::Def_p,13}, {StatType::CRate,20}, {StatType::Atk_p,5} } ),
