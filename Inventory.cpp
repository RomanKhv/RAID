...
std::vector<Artefact> _MyArts =
{
	...
	Artefact{ ArtType::Weapon, ArtSet::Vamp, 5, 0, StatType::Atk, { {StatType::CDmg,6}, {StatType::CRate,4} } },
	...
	Artefact{ ArtType::Gloves, ArtSet::Vamp, 4, 8, StatType::Atk_p, { {StatType::Atk,19}, {StatType::Acc,15} } },
